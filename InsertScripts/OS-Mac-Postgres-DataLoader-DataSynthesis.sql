...
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./ReferenceData/refdata_devicetypes.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./ReferenceData/refdata_industries.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./ReferenceData/refdata_industriestobusiness.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./ReferenceData/refdata_legalentities.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./ReferenceData/refdata_organization.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./ReferenceData/refdata_application.sql
-- Data Model
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataModel/datamodel_domain.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataModel/datamodel_datatables.sql
-- Platform
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./Platform/platform_dataattributes.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./ReferenceData/10-refdata_datagentypes.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./Platform/platform_config_dataattributes.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./Platform/platform_config_datastructures.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./Platform/platform_config_datastructures_dtl.sql
-- DataExisting
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataExisting/dataexisting_ababanking.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataExisting/dataexisting_areacode.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataExisting/dataexisting_companies.sql
...
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataExisting/dataexisting_profession.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataExisting/dataexisting_upccodes.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataExisting/dataexisting_zipcodeus.sql
-- DataGenerated
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataGenerated/datagenerated_accountnumbers.sql
...
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataGenerated/datagenerated_devices.sql
...
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataGenerated/datagenerated_ein.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataGenerated/datagenerated_phonenumbers.sql
/Library/PostgreSQL/14/bin/psql -h localhost -U postgres -d datasynthesis -p 5432 -f ./DataGenerated/datagenerated_serialnumbers.sql
